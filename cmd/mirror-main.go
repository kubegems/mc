...
// juicefs sync s3://ktirw93reit6136h:xtfk7hgevtnjpvqn@lfs-objects.prod-s3.harix.iamidata.com  minio://minioadmin:minioadmin@127.0.0.1:9527/lfs-objects --threads 10 --ignore-existing > forword.out 2>&1 &
...
// mc mirror --older-than 1h lfs/lfs-objects local1/lfs-objects
// mc mirror --newer-than 3h lfs/lfs-objects local1/lfs-objects
var (
...
// mc mirror --older-than 720d s3/mybucket/ s3/mybucket-backup/
